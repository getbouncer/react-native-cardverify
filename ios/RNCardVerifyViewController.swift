...
// MARK: Custom Verify
class RNCardVerifyViewController: VerifyCardViewController {
    ...
    override func viewDidLoad() {
      if let wrongCardString = verifyStyle.wrongCardText {
        RNCardVerifyViewController.wrongCardString = wrongCardString
      }
    ...
    override public func setupDenyUi() {
        ...
        let text = verifyStyle.enableCameraPermissionText ?? RNCardVerifyViewController.enableCameraPermissionString
